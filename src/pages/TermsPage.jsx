...
export default function TermsPage({ lang = 'en', ui, toolData }) {
  const { isPro } = useAuth();
  return (
    <div className="max-w-4xl mx-auto px-4 py-12 md:py-20 animate-fade-in font-sans">
      <div className="mb-10 text-center">
        <h1 className="text-4xl font-extrabold text-gray-900 tracking-tight">{toolData?.title || 'Terms of Service'}</h1>
