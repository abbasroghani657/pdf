...
export default function AboutPage({ lang = 'en', ui, toolData }) {
  return (
    <div className="max-w-4xl mx-auto px-4 py-16 animate-fade-in">
      <SEOHead 
        title="About TheyLovePDF" 
        description="Learn about the team behind TheyLovePDF, building the world's best free PDF tools." 
        url="/about"
      />
      
      <div className="text-center mb-16">
        <h1 className="text-4xl font-extrabold text-gray-900 mb-4">{toolData?.title || 'About TheyLovePDF'}</h1>
      ...
      <div className="bg-white rounded-3xl p-8 md:p-12 shadow-sm border border-gray-100 mb-10">
        <div className="prose prose-blue max-w-none">
          ...
          <p className="text-gray-600 mb-8 leading-relaxed">
            TheyLovePDF was built by a passionate global team of developers and document experts. Our mission is simple: 
            provide enterprise-grade PDF tools to the world, for free. Whether you are a student merging assignments, 
            a professional redacting sensitive contracts, or a developer extracting OCR data, TheyLovePDF is designed 
            to save you time and frustration.
          </p>

          <h2 className="text-2xl font-bold text-gray-900 mb-4">Privacy First</h2>
          <p className="text-gray-600 mb-8 leading-relaxed">
            We understand that your documents contain sensitive information. That's why we engineered TheyLovePDF 
          ...
          <p className="text-gray-600 mb-8 leading-relaxed">
            TheyLovePDF operates globally, providing high-availability digital services to millions of users. We are continuously 
