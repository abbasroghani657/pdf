          ...
          <table className="w-full text-left border-collapse">
            <thead>
              <tr className="bg-gray-50/60 border-b border-gray-100">
                <th className="py-4 px-6 text-sm font-semibold text-gray-500 w-2/5">
                ...
                <th className="py-4 px-6 text-sm font-semibold text-gray-400 w-[30%] border-l border-gray-100">
            ...
            <tbody className="divide-y divide-gray-50">
              {[
                { feature: lang === 'es' ? 'Límite de tamaño gratuito' : lang === 'fr' ? 'Limite de taille gratuite' : lang === 'de' ? 'Kostenloses Dateigrößenlimit' : lang === 'pt' ? 'Limite de tamanho gratuito' : 'Free file size limit', us: '10 MB', them: '5 MB', winner: false },
                { feature: lang === 'es' ? 'Herramientas con IA' : lang === 'fr' ? 'Outils avec IA' : lang === 'de' ? 'KI-gestützte Tools' : lang === 'pt' ? 'Ferramentas com IA' : 'AI-powered tools', us: lang === 'es' ? '✓ Sí (5 herramientas)' : lang === 'fr' ? '✓ Oui (5 outils)' : lang === 'de' ? '✓ Ja (5 Tools)' : lang === 'pt' ? '✓ Sim (5 ferramentas)' : '✓ Yes (5 tools)', them: lang === 'es' ? '✗ No' : lang === 'fr' ? '✗ Non' : lang === 'de' ? '✗ Nein' : lang === 'pt' ? '✗ Não' : '✗ No', winner: true, usClass: 'text-emerald-600', themClass: 'text-red-400' },
                { feature: lang === 'es' ? 'Precio de suscripción Pro' : lang === 'fr' ? 'Prix de l\'abonnement Pro' : lang === 'de' ? 'Preis für Pro-Abo' : lang === 'pt' ? 'Preço da assinatura Pro' : 'Pro subscription price', us: '$4.99/mo', them: '$9.99/mo', winner: true },
                { feature: lang === 'es' ? 'Total de herramientas' : lang === 'fr' ? 'Total des outils' : lang === 'de' ? 'Verfügbare Tools' : lang === 'pt' ? 'Total de ferramentas' : 'Total tools available', us: '37+', them: '25', winner: true },
                { feature: lang === 'es' ? 'Sin registro' : lang === 'fr' ? 'Sans inscription' : lang === 'de' ? 'Keine Anmeldung' : lang === 'pt' ? 'Sem registro' : 'No signup required', us: lang === 'es' ? '✓ Sí' : lang === 'fr' ? '✓ Oui' : lang === 'de' ? '✓ Ja' : lang === 'pt' ? '✓ Sim' : '✓ Yes', them: lang === 'es' ? '✗ No' : lang === 'fr' ? '✗ Non' : lang === 'de' ? '✗ Nein' : lang === 'pt' ? '✗ Não' : '✗ No', winner: true, usClass: 'text-emerald-600', themClass: 'text-red-400' },
                { feature: lang === 'es' ? 'Velocidad de procesamiento' : lang === 'fr' ? 'Vitesse de traitement' : lang === 'de' ? 'Verarbeitungsgeschwindigkeit' : lang === 'pt' ? 'Velocidade de processamento' : 'Processing speed', us: lang === 'es' ? 'Rápida y Segura' : lang === 'fr' ? 'Rapide et Sécurisé' : lang === 'de' ? 'Schnell & Sicher' : lang === 'pt' ? 'Rápida e Segura' : 'Fast & Secure', them: lang === 'es' ? 'Estándar' : lang === 'fr' ? 'Standard' : lang === 'de' ? 'Standard' : lang === 'pt' ? 'Padrão' : 'Standard', winner: true },
                { feature: lang === 'es' ? 'Acceso API gratis' : lang === 'fr' ? 'Accès API gratuit' : lang === 'de' ? 'API-Zugriff kostenlos' : lang === 'pt' ? 'Acesso API grátis' : 'API access on free plan', us: lang === 'es' ? '✗ Solo Pro' : lang === 'fr' ? '✗ Pro uniquement' : lang === 'de' ? '✗ Nur Pro' : lang === 'pt' ? '✗ Apenas Pro' : '✗ Pro only', them: lang === 'es' ? '✗ Solo Pro' : lang === 'fr' ? '✗ Pro uniquement' : lang === 'de' ? '✗ Nur Pro' : lang === 'pt' ? '✗ Apenas Pro' : '✗ Pro only', winner: false },
                { feature: lang === 'es' ? 'Procesamiento por lotes' : lang === 'fr' ? 'Traitement par lots' : lang === 'de' ? 'Stapelverarbeitung' : lang === 'pt' ? 'Processamento em lote' : 'Batch processing', us: lang === 'es' ? '✓ Sí' : lang === 'fr' ? '✓ Oui' : lang === 'de' ? '✓ Ja' : lang === 'pt' ? '✓ Sim' : '✓ Yes', them: lang === 'es' ? '✓ Sí' : lang === 'fr' ? '✓ Oui' : lang === 'de' ? '✓ Ja' : lang === 'pt' ? '✓ Sim' : '✓ Yes', winner: false, usClass: 'text-emerald-600', themClass: 'text-emerald-500' },
                { feature: lang === 'es' ? 'Auto-eliminación de archivos' : lang === 'fr' ? 'Auto-suppression' : lang === 'de' ? 'Autom. Dateilöschung' : lang === 'pt' ? 'Autoexclusão de arquivos' : 'File auto-delete', us: lang === 'es' ? '2 horas' : lang === 'fr' ? '2 heures' : lang === 'de' ? '2 Stunden' : lang === 'pt' ? '2 horas' : '2 hours', them: lang === 'es' ? '2 horas' : lang === 'fr' ? '2 heures' : lang === 'de' ? '2 Stunden' : lang === 'pt' ? '2 horas' : '2 hours', winner: false },
              ].map((row, i) => (
