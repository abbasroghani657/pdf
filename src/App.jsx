          ...
          <div className="relative max-w-4xl mx-auto px-4">
            {isHome && (
              <div className="flex justify-center mb-5">
                <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-2xl bg-gradient-to-r from-blue-50 to-indigo-50 text-[#378ADD] font-extrabold text-sm sm:text-base tracking-[0.2em] uppercase border border-blue-100/50 shadow-sm">
      ...
      <main className={clsx(
        ...
        <Suspense fallback={<div className="flex items-center justify-center min-h-[50vh]"><div className="w-8 h-8 border-4 border-[#378ADD] border-t-transparent rounded-full animate-spin"></div></div>}>
          <Routes>
            ...
            <Route path="/tools/:toolSlug" element={<ToolRenderer ui={uiDict} toolsData={currentToolsData} />} />
            <Route path="/tools/:toolSlug/:platform" element={<ToolRenderer ui={uiDict} toolsData={currentToolsData} />} />
            ...
            {SUPPORTED_LANGS.filter(l => l !== 'en').map(lang => (
              <React.Fragment key={lang}>
                ...
                <Route path={`/${lang}/tools/:toolSlug`} element={<ToolRenderer lang={lang} ui={uiDict} toolsData={currentToolsData} />} />
                <Route path={`/${lang}/tools/:toolSlug/:platform`} element={<ToolRenderer lang={lang} ui={uiDict} toolsData={currentToolsData} />} />
